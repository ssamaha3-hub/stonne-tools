...
# parameters that should always be treated as integers
INT_PARAMS = {
    "M",
    "N",
    "K",
...
# normalize the fixed section of the yaml config
...
# normalize the sweep section and make sure each sweep value is a non-empty list
...
# load the yaml config, normalize values, and validate it
def load_config(config_path):
    ...
    # require the expected top-level structure
    ...
    # optional custom run name template
    ...
    # validate the fully normalized config before returning it
